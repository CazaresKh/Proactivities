...
namespace API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
        {
            ...
            var message =
                $"<p>Please click the below link to verify your email address:</p><p><a href='{verifyUrl}'>Click to verify email</p>";
        ...
        public async Task<ActionResult<UserDto>> RefreshToken()
        {
            ...
            if (oldToken is {IsActive: false}) //oldToken != null && !oldToken.IsActive
            {
                return Unauthorized();
            }
