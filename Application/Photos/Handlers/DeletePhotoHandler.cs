...
{
    public class DeletePhotoHandler : SupportHandler, IRequestHandler<DeletePhotoCommand, Result<Unit>>
    {
        public DeletePhotoHandler(DataContext context, IPhotoAccessor photoAccessor, IUserAccessor userAccessor) :
